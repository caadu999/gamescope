    ...
    <>
      ...
      <div className="min-h-[calc(100vh - 80px)] flex flex-col items-center p-4 text-[#fdf9f0]">
        ...
        <p className="text-[#dadada] xl:hidden xl:text-[22px]">
          Reunimos detalhes completos sobre milhares de títulos: sinopses,
          notas, plataformas disponíveis, datas de lançamento, gêneros,
          desenvolvedoras e muito mais. Tudo pensado para facilitar sua pesquisa
          e ajudar você a descobrir novos jogos ou relembrar clássicos.
        </p>
        <p className="mt-2 text-[#dadada] xl:hidden">
          Além disso, o Gamescope conta com um sistema de lista de desejos
          <span className="border-b-2 font-bold"> wishlist</span>, onde você
          pode salvar os jogos que mais chamaram sua atenção e acompanhar tudo o
          que ainda pretende jogar sem perder nenhum título de vista.
        </p>
        <Link
          href={'/jogos'}
        ...
        <div className="flex flex-col md:flex-row md:gap-2 xl:m-auto xl:mb-4 xl:w-[80%] xl:justify-center xl:gap-4">
          ...
          <div className="mt-6 flex w-full flex-col justify-center gap-2 rounded-lg border-[1px] border-solid border-[#434141] bg-[#1b1d22] p-4 xl:h-52">
            ...
            <p className="w-[60%] text-[16px] text-[#979494] md:w-[80%]">
              Salve os jogos que você quer jogar e nunca mais perca um
              lançamento de vista.
            </p>
          </div>
          <div className="mt-6 flex w-full flex-col justify-center gap-2 rounded-lg border-[1px] border-solid border-[#434141] bg-[#1b1d22] p-4 xl:h-52">
