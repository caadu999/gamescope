  ...
  return (
    <Link href={`/jogos/${jogos.slug}`}>
      <CursorFollow label="Veja o destaque">
        <section className="flex w-96 flex-col items-center rounded-xl border-[1px] border-solid border-[#2e2e2e] bg-[#111111] p-4 md:w-full lg:h-[400px] lg:w-[920px] lg:flex-row lg:gap-6 lg:p-4 xl:w-[1100px]">
          <div
